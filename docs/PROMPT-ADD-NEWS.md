...
```
建议提供 1-3 个相关链接，如官方公告、新闻报道、技术文档等。
...
相关链接：
- OpenAI 官方公告：https://openai.com/blog/gpt-5
- 技术白皮书：https://openai.com/research/gpt-5-paper

**注意**：publishedAt（发布日期）由 LLM 自动获取当前日期生成，无需手动提供。
...
4. LLM 将输出 JSON 数据
5. 将 JSON 条目添加到 `src/data/news.json` 数组末尾
