---
uid: "80054000"
introduction: "Ruflo是一个全面的AI代理编排框架，将Claude Code转变为强大的多代理开发平台，使团队能够部署、协调和优化共同完成复杂软件工程任务的专用AI代理。"
---
...
![Ruflo Banner](https://raw.githubusercontent.com/ruvnet/claude-flow/main/ruflo-small.jpeg)
