---
uid: MC-000004
introduction: "Baidu Map MCP Server 是一个完全符合 MCP 协议的开源基于位置的服务解决方案，为开发者和 AI 代理提供全面的地理空间 API 和工具。"
---
...
[![Star History Chart](https://raw.githubusercontent.com/baidu-maps/mcp/main/svg)](https://star-history.com/#baidu-maps/mcp&Date)
