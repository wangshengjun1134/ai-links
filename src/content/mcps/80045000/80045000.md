---
uid: "80045000"
introduction: "Markdownify MCP Server是一个将多种文件类型（如PDF、图片、音频等）和网页内容转换为Markdown格式的工具。"
---

# Markdownify MCP Server

![markdownify mcp logo](https://raw.githubusercontent.com/zcaceres/markdownify-mcp/main/142)
