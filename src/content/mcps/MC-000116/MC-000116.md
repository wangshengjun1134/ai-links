---
uid: "80117000"
introduction: "八字 MCP 是一款基于 AI 的八字计算器，提供精准的八字排盘数据，用于性格分析和命运预测。"
---

# Bazi MCP (八字 MCP) by Cantian AI


[![](https://smithery.ai/badge/@cantian-ai/bazi-mcp)](https://smithery.ai/server/@cantian-ai/bazi-mcp)
[![](https://mseep.ai/badge.svg)](https://mseep.ai/app/453ac410-d93a-45fb-8563-7d3cccfbe956)
...
项目源于 GPT Store 热门应用[*Chinese Bazi Fortune Teller*](https://chatgpt.com/g/g-67c3f7b74d148191a2167f44fd13412d-chinese-bazi-fortune-teller-can-tian-ba-zi-suan-ming-jing-zhun-pai-pan-jie-du)，现已融入**参天 AI**平台 ([cantian.ai](https://cantian.ai))。我们诚邀命理研究者与 AI 开发者加入，共同推动中国传统文化的传承与创新。
...
![WeChat QR Code](https://gips0.baidu.com/it/u=1716375181,632261997&fm=3081&app=3081&f=PNG?w=1074&h=1455)
...
BASH```
1npx -y @smithery/cli install @cantian-ai/bazi-mcp --client claude
```
...
JSON```
1["1758-07-29 14:00:00", "1818-07-15 14:00:00", "1998-07-31 14:00:00"]
```
