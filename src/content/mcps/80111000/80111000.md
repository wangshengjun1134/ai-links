---
uid: "80111000"
introduction: "一个让AI助手能够通过必应搜索引擎实时获取网络信息的工具，支持中文优化和网页内容抓取。"
---
...
- 小红书 ([xiaohongshu.com](http://xiaohongshu.com))
- 微博 ([weibo.com](http://weibo.com))
- 微信公众号 ([weixin.qq.com](http://weixin.qq.com))
- 抖音/TikTok ([douyin.com](http://douyin.com), [tiktok.com](http://tiktok.com))
- B站 ([bilibili.com](http://bilibili.com))
...
**提问**: “帮我抓取这个网页的内容 [https://example.com/article](https://example.com/article)”
...
1. **网络问题**: 检查是否能正常访问 [cn.bing.com](http://cn.bing.com)
