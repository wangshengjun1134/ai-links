---
uid: "80174000"
introduction: "文颜MCP Server是一款多平台Markdown排版与发布工具，支持将Markdown一键转换并发布至微信公众号、知乎、今日头条等内容平台，特别适合AI写作与公众号发布的自动化流程。"
---

![logo](https://gips1.baidu.com/it/u=372114661,69981006&fm=3081&app=3081&f=PNG?w=1080&h=608)

# 文颜 MCP Server


[![](https://img.shields.io/npm/v/@wenyan-md/mcp)](https://www.npmjs.com/package/@wenyan-md/mcp)

![](https://img.shields.io/npm/dm/%40wenyan-md%2Fmcp)
[![](https://img.shields.io/docker/pulls/caol64/wenyan-mcp)](https://hub.docker.com/r/caol64/wenyan-mcp)
[![](https://img.shields.io/github/stars/caol64/wenyan-mcp?style=social)](https://github.com/caol64/wenyan-mcp)
...
4
5
6目前我支持的公众号主题包括以下这些，每个主题都有独特的风格和配色，适用于不同的内容调性：
1. **Default（默认）**  
   简洁经典的排版，适合长文阅读，通用性强。
2. **OrangeHeart（橙心）**  
...
> 帮我把这个css([https://wenyan.yuzhi.tech/manhua.css](https://wenyan.yuzhi.tech/manhua.css))注册为一个新的公众号主题，名称为：xiuluochang
...
1
2
3好的，已成功将 CSS 样式表注册为新的公众号主题，主题名称为：**xiuluochang**。
...
BASH```
1docker pull caol64/wenyan-mcp:latest
```
...
BASH```
1npx @modelcontextprotocol/inspector <command>
```
...
1
2
3🔗 Open inspector with token pre-filled:
